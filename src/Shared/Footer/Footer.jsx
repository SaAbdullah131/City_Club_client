...
import footerLogo from '../../assets/city_club_logo.jpg';
        ...
        <form>
            <div class="footer p-10 bg-green-400 text-white font-semibold rounded-xl">
                ...
                <div>
                    ...
                    <p>Avenue-01,Section-11.5,Mirpur,<br />Dhaka-1216</p>
                    <p>Tell: +8809834333 <br /> +880009988343</p>
                    <p>Phone: +8801759655598 <br /> +8801759655598</p>
                </div>
                <div>
                    <span className="footer-title">Newsletter</span>
                    <div className="form-control w-80">
                        <label className="label">
                            <span className="label-text text-white">GET ALL UPDATE FROM US</span>
                        </label>
